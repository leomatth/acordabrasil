...
import { getDeputadoExpenses } from "@/lib/services/camaraExpensesService";
...
export async function GET(
  ...
  try {
    const result = await getDeputadoExpenses(deputadoId, {
    ...
    return NextResponse.json(
      {
        error: "Não foi possível buscar despesas do deputado na Câmara.",
